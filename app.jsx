...
export const App = () => {
  const [transactions, setTransactions] = useState([
    ...
    },
    {
      ...
      amount: 900000,
      description: 'Alat dan perkakas',
    },
    {
      date: '03/01/23',
      category: 'Body Care',
      amount: 3000000,
      description: 'Sabun, Shampo, DLL',
    },
  ]);
      ...
      <main className='main-content'>
        <div className='desktop'>
          <section className='summary'>
            ...
            <div className='cards'>
              ...
              <div className='card'>
                ...
                <p className='value'>
                  Rp. {formatNumber(cardContent.pengeluaran)}
                </p>
              </div>
              <div className='card'>
                <p className='label'>Pemasukan bulan ini:</p>
                <p className='value'>
                  Rp. {formatNumber(cardContent.pemasukan)}
                </p>
                <button className='edit-card-btn' onClick={handleEditCard}>
                  Edit
                </button>
              </div>
            </div>
          ...
          <section className='add-transaction'>
            <h2>
              {editIndex !== null ? 'Edit Transaksi' : 'Tambah Transaksi'}
            </h2>
